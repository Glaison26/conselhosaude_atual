...
$sql = "SELECT TRABSUS_NOME FROM cadastro WHERE id = $user_id";
$result = mysqli_query($conection, $sql);
$nome_usuario = mysqli_fetch_assoc($result);



$sql = "
    SELECT id, TRABSUS_NOME, APRESENTACAO, FOTO
    FROM cadastro 
    WHERE CATEGORIA = 2
    AND CANDIDATO = 'S'
    ORDER BY TRABSUS_NOME
";
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-4">
                         Olá <?= htmlspecialchars($nome_usuario['TRABSUS_NOME']) ?>, Selecione o Candidato
                    </h3>
                    ...
                    <form action="processar_voto.php" method="POST">
                        ...
                        <button type="button" class="btn btn-danger w-100" onclick="history.back()">
                            Voltar
                        </button>
