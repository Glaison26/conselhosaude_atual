...
$sql = "SELECT ORG_NOMEORG FROM cadastro WHERE id = $user_id";
$result = mysqli_query($conection, $sql);
$nome_ong = mysqli_fetch_assoc($result);

$sql = "
    SELECT id, ORG_NOMEORG, APRESENTACAO, FOTO
    FROM cadastro 
    WHERE CATEGORIA = 3
    AND CANDIDATO = 'S'
    ORDER BY ORG_NOMEORG
";
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <h3 class="card-title mb-4">
                         Olá <?= htmlspecialchars($nome_ong['ORG_NOMEORG']) ?>, Selecione o Candidato
                    </h3>
