    ...
    <div class="container -my5">
        ...
        <table class="table display table-hover  table-condensed tablista">
            ...
            <tbody>
                ...
                $c_sql = "SELECT id, sus_nome, sus_rg, sus_cpf, sus_unidade, candidato FROM cadastro where cadastro.categoria='1'";
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <tr>
                    <td>$c_linha[id]</td>
                    <td>$c_linha[sus_nome]</td>   
                    <td>$c_linha[sus_unidade]</td>
                    <td>$c_linha[sus_rg]</td>               
                    <td>$c_linha[sus_cpf]</td>
                    <td>$c_tipocadastro</td>
                    <td>
              
                    <a class='btn btn-success btn-sm' title='Abrir detalahamento do item' href='/conselhosaude/detalhe1.php?id=$c_linha[id]'><span class='glyphicon glyphicon-zoom-in'></span></a>
