...
<body>
    ...
    <div class="panel panel-light" style="background-color: #e3f2fd;">
        <div class="panel-heading text-center">
            ...
            <h2>Organizações não Governamentais</h2>
        </div>
    </div>
    ...
    <div class="container -my5">
        ...
        <table class="table display table-hover  table-condensed tablista">
            ...
            <tbody>
                ...
                $c_sql = "SELECT id, ORG_NOMEORG, ORG_CPFREPRE, ORG_CNPJ, ORG_NOMEREPRESENTANTE, candidato FROM cadastro where cadastro.categoria='3'";
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <tr>
                    <td>$c_linha[id]</td>
                    <td>$c_linha[ORG_NOMEORG]</td>   
                    <td>$c_linha[ORG_NOMEREPRESENTANTE]</td>
                    <td>$c_linha[ORG_CPFREPRE]</td>               
                    <td>$c_linha[ORG_CNPJ]</td>
                    <td>$c_tipocadastro</td>
                    <td>
                          
                    <a class='btn btn-success btn-sm' title='Abrir detalahamento do item' href='/conselhosaude/detalhe3.php?id=$c_linha[id]'><span class='glyphicon glyphicon-zoom-in'></span></a>
